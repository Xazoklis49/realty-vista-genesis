            ...
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={service.id}
                  id={service.id}
                  className={`rounded-2xl border border-border/20 shadow-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 overflow-hidden scroll-mt-24 ${
                    isEven ? "bg-accent/20" : "bg-background"
                  }`}
                >
                  <div className="grid lg:grid-cols-12 gap-6 md:gap-8 p-6 md:p-8">
                    {/* Text Block */}
                    <div
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-3">
                        <Button
                          onClick={() => handlePrimaryCTA(service.title)}
                          size="lg"
                        >
                          {service.ctaPrimary}
                        </Button>
